...
pub(crate) fn parse_character(api:&EnkaNetwork,player_character:&Value)->Result<Character,CharacterParseError>{
	...
	Ok(Character{
		...
		costumes,
		current_costume,
		gachaslice:find(characters,"filename_gachaSlice"),
		gachasplash:find(characters,"filename_gachaSplash"),
		icon:find(characters,"filename_icon"),
		iconcard:find(characters,"filename_iconCard"),
		friendship,
